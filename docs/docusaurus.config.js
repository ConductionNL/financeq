...
const config = createConfig({
  title: 'FinanceQ',
  tagline: 'Financial workflow, invoicing, and bookkeeping on Nextcloud. Built on OpenRegister and the Conduction quality pipeline.',
  url: 'https://financeq.conduction.nl',
  baseUrl: '/',

  organizationName: 'ConductionNL',
  projectName: 'financeq',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/financeq/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/financeq',
        label: 'Codeberg',
        position: 'right',
      },
