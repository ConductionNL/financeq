# Context Brief: Cost Accounting & Allocation — Shillinq
...
**Spec:** cost-accounting-allocation
...
**Lives at:** Begroting > Kostenverdeling

**Rationale:** cost allocation runs against budget  
_Source: /tmp/ia-small5.md_

> **Implementation note for builders:** Respect the placement above. Do not promote this spec to a top-level menu item, sub-page, or new route unless the placement type explicitly says so. If the placement is `DETAIL_TAB`, `WIDGET`, `ACTION`, `SETTING`, or `INFRA`, the feature must NOT introduce a new entry in the app sidebar. When in doubt, ask before creating a new top-level surface.

## Features (54 total, sorted by market demand)

### Inventory management with average cost valuation
**demand: 1596** (530 tender mentions, 3% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Team time tracking with per-member hour logging
**demand: 384** (126 tender mentions, 3% competitor coverage) | Category: analytics
Clustered from 2 mentions: 2 competitor features

### Report by cost center, project and department dimensions
**demand: 240** (65 tender mentions, 21% competitor coverage) | Category: analytics
Clustered from 1 mentions: 1 user stories

### Schedule recurring monthly overhead allocation
**demand: 200** (66 tender mentions, 1% competitor coverage) | Category: scheduling
Clustered from 1 mentions: 1 user stories

### Profit & Loss with multi-dimensional analysis (cost center, project, department)
**demand: 178** (56 tender mentions, 5% competitor coverage) | Category: other
Clustered from 2 mentions: 2 competitor features

### Built-in time tracker with start/stop timer and manual entry
**demand: 124** (40 tender mentions, 2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Timesheet overview with weekly/monthly summary and utilization metrics
**demand: 100** (32 tender mentions, 2% competitor coverage) | Category: ai
Clustered from 1 mentions: 1 competitor features

### Version control the cost allocation model
**demand: 94** (29 tender mentions, 3% competitor coverage) | Category: document-management
Clustered from 1 mentions: 1 user stories

### Configurable approval chains based on spend amount, category, cost center, and plant
**demand: 88** (26 tender mentions, 5% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Cost center tracking for departmental expense analysis
**demand: 83** (23 tender mentions, 7% competitor coverage) | Category: analytics
Clustered from 1 mentions: 1 competitor features

### Approval routing by location, department, and cost center with escalation rules
**demand: 79** (25 tender mentions, 2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Inventory tracking with FIFO cost valuation method
**demand: 77** (23 tender mentions, 4% competitor coverage) | Category: analytics
Clustered from 1 mentions: 1 competitor features

### Kostenplaats- en kostendrager administratie
**demand: 73** (22 tender mentions, 3% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Project accounting with time and cost allocation
**demand: 70** (20 tender mentions, 5% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Dimension-based accounting (cost center, project, activity, free fields)
**demand: 49** (15 tender mentions, 2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Calculate full cost price per product
**demand: 39** (13 tender mentions) | Category: other
Clustered from 1 mentions: 1 user stories

### Automated account assignment with pre-configured cost center and GL mappings
**demand: 31** (9 tender mentions, 2% competitor coverage) | Category: ai
Clustered from 1 mentions: 1 competitor features

### Cost center and project-based accounting with allocation rules
**demand: 19** (3 tender mentions, 5% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### View overhead allocation breakdown per product
**demand: 15** (5 tender mentions) | Category: other
Clustered from 1 mentions: 1 user stories

### Cost Center Allocation
**demand: 13** (6% competitor coverage) | Category: other
Clustered from 2 mentions: 2 competitor features

### Auto Per Diem Calculation
**demand: 11** (1 tender mentions, 4% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Company-custom Per Diem Rates
**demand: 10** (2 tender mentions, 2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Cost center and GL account allocation with automated coding
...
### Cost center and profit center allocation for departmental accounting
**demand: 8** (4% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Auto-log business trips via GPS on my phone
...
### Country-specific Mileage Rates
...
### Dutch Mileage Rate (EUR 0.23/km)
**demand: 5** (1 tender mentions, 1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Rule triggers based on description, amount, source, destination, and notes
**demand: 5** (1 tender mentions, 1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Commute vs Business Trip Split
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Run overhead cost allocation to products
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 user stories

### Spread Costs/Revenue
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Reverse an incorrect overhead allocation
...
### Define volume drivers for product cost price calculation
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

### Compare calculated cost price to current tariff
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

### Assign overhead cost pools to products and programmes
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

### Define a new overhead allocation key
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

## User Stories (1 linked)

### Story 1: Run overhead cost allocation to products
**Priority:** must
...
APTransaction, Account, AccountabilityReport, Administration, ApprovalChain, ApprovalRequest, ApprovalRoute, ApprovalTask, AssessmentCriteria, Assignment, Auction, AuditFinding, AuditorStatement, AwardDecision, AwardNotice, BalanceSheet, BankAccount, Bid, BidEvaluation, BiddingRound, BlanketPurchaseOrder, Branch, Budget, BudgetAllocation, BudgetAmendment, BudgetPeriod, CallOffOrder, CashAccount, CatalogItem, ChargebackDispute, ComplianceAssessment, ComplianceAudit, ComplianceDocument, ComplianceReport, ComplianceRisk, ConsentRecord, ConsolidatedReport, ConsolidationGroup, Contract, ContractClause, ContractMilestone, ContractModification, ContractObligation, ContractParty, ContractPerformance, ContractRedline, ContractRenewal, ContractSpendRecord, ContractTemplate, Corporation, CreditNote, CurrencyBalance, DebitNote, Deduction, Delegation, DelegationRule, DepreciationSchedule, DigitalDocument, Dividend, Document, DunningNotice, Entitlement, Entity, EvaluationCriterion, Event, ExemptionCertificate, ExpenditureEscalation, ExpenditureRequest, Expense, ExpenseCategory, ExpenseClaim, ExpenseLineItem, ExpenseReport, FXExposure, FinancialDecision, FinancialReport, FiscalYear, FixedAsset, FrameworkAgreement, Freelancer, FundAllocation, FundingSource, GeneralLedgerAccount, GeneralLedgerEntry, GoodsReceipt, GovernmentEntity, Grant, GrantPortfolio, IntercompanyTransaction, InventoryItem, InventoryStock, Investment, Invoice, InvoiceLine, JointVenture, JournalEntry, LiquidityForecast, Location, Lot, ManagementLetter, Mandate, MandateAuditLog, MandateRequest, MandateScheme, MandateViolation, MarketplaceApp, MarketplaceIntegration, MaverickSpendAlert, MonetaryAmount, OAuthIntegration, Obligation, ObligationSettlement, ObligationTask, Offer, Order, Organization, Payee, Payment, PaymentBatch, PaymentFraudAssessment, PaymentRiskScore, Payroll, PeppolAccessPoint, PeppolParticipant, PerformanceImprovementAction, PerformanceScore, Permission, Person, PolicyRule, PolicyViolation, PricingRule, ProcurementAuditLog, ProcurementCatalog, ProcurementCategory, ProcurementComplianceReport, ProcurementOrder, ProcurementProcedure, ProcurementQuote, Product, Project, ProjectTask, ProofOfDelivery, Property, PropertyAssessment, PublicProcurement, PublicationAmendment, PublicationLog, PublicationNotice, PurchaseOrder, PurchaseOrderChange, PurchaseOrderRevision, PurchaseRequisition, QualificationDeclaration, QualityManagementSystem, Quote, RateCard, Receipt, Report, RequestForQuotation, RevenueStream, RiskCriteria, Role, SavingsOpportunity, ScheduledPayment, ServiceLevelAgreement, SettlementDecision, Share, Shareholder, SigningAuthority, SourcingEvent, SpendCategory, SpendTransaction, SpendingRecord, StatementOfWork, SubmissionDossier, Subscription, SubsidyApplication, SubsidyScheme, Supplier, SupplierBid, SupplierCertificate, SupplierDocument, SupplierKPI, SupplierPerformanceReport, SupplierPerformanceScore, SupplierPerformanceScorecard, SupplierPortalAccount, SupplierPortalUser, SupplierQualification, SupplierRiskProfile, SupplierSLA, SupplierSurvey, SupplyChainRisk, TaxConfiguration, TaxDeclaration, TaxExemption, TaxLot, TaxRate, TaxReturn, TaxableTransaction, Team, Tender, TenderAmendment, TenderDocument, TenderLineItem, TenderLot, TenderNotice, TimeEntry, Transaction, TreasuryTask, TrialBalance, User, UserPreference, VATReturn, VendorBill, WOZAssessment, XBRLInstance, XBRLTaxonomy
