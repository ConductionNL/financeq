# Context Brief: Treasury & Cash Management — Shillinq — Other T3
...
**Spec:** treasury-cash-management-other-t3
...
**Lives at:** Treasury > Beleggingen

**Rationale:** investments  
...
### Plaid Link secure bank account connection widget
**demand: 5** (1 tender mentions, 1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Produce 13-week rolling cash flow forecast
...
### Configure custom auto-matching rules for bank reconciliation
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 user stories

### Instant bank payment initiation (A2A transfers)
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Credit card acquiring (Visa/Mastercard/Amex) with 3D Secure
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Platform fee calculation and deduction from splits
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Bank reconciliation with auto-matching and manual adjustment options
**demand: 4** (2% competitor coverage) | Category: other
...
### Cash flow optimization with payment timing recommendations
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Variable recurring payments via open banking
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### White-label bank connection experience
**demand: 3** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### BTCPay Server Bitcoin/cryptocurrency payment acceptance
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### International wire transfer to 130+ countries
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Payment scheduling with future-dated payments
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Transparent FX rates for international transfers
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Manual transaction entry for cash and offline payments
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Verified Mandates with bank account verification
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### 2,500+ bank connections across Europe
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### 3,400+ bank connections across 18 European markets
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Multi-bank payment comparison (best rate routing)
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Identity verification from bank account profile data
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Tokenization for secure recurring card payments
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
