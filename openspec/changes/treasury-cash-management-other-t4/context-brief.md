# Context Brief: Treasury & Cash Management — Shillinq — Other T4
...
**Spec:** treasury-cash-management-other-t4
...
**Lives at:** Treasury > Schatkistbankieren

**Rationale:** RIH compliance  
...
### Identify loans eligible for refinancing
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

### View cash flow graph
**demand: unknown** | Category: other
...
### View portfolio of all active payment arrangements
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories
...
### Verify supplier IBAN bank account
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories

### Payment provider per administration
**demand: unknown** | Category: other
Clustered from 1 mentions: 1 user stories
