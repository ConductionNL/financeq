# Context Brief: Tax & Levy Management — Shillinq — Other T2
...
**Spec:** tax-levy-management-other-t2
...
**Lives at:** Belastingen > Bezwaren

**Rationale:** objection handling  
...
### Configurable tax rates with compound and inclusive/exclusive options
**demand: 6** (3% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Auto-classification of invoices by country, language, VAT, currency
...
### Wage tax (loonheffing) filing directly to Belastingdienst
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 2 mentions: 2 competitor features

### Automatic BTW-aangifte preparation with pre-filled amounts
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### 300M+ Tax Rules Database
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Automatic BTW-aangifte calculation with pre-filled return
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### CCH SureTax Sales Tax Engine
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### ML receipt/invoice OCR with 99% accuracy and VAT code auto-suggestion
**demand: 4** (2% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Interim BTW check to prevent surprises at filing time
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Expense categorization with tax-relevant grouping
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### CCH Axcess Tax (Cloud)
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Auto-calculating Tax Forms
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### CCH ProSystem fx Tax (On-prem)
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Dutch VAT Automation
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### Dutch GAAP Tax Mapping
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Multi-taxonomy Validation
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Apply KOR (Kleineondernemersregeling) VAT exemption
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 user stories
...
### Avalara Returns (Auto-filing)
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### KvK/BTW number lookup and validation
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 2 mentions: 1 user stories, 1 competitor features

### Vendor 1099 tax form preparation
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Brazilian Tax Support
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
...
### VAT ID Validator (67+ countries)
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features

### Cross-border Situs Logic
**demand: 2** (1% competitor coverage) | Category: other
Clustered from 1 mentions: 1 competitor features
